        ...
        init: function () {
            ...
            var oTable = $('#expandabledatatable').dataTable({
                ...
                "aoColumns" : [ {
                    ...
                    "mRender": function (data, type, full) {
                    	 ...
                    	 if(full.description==""||full.description==null)
                    		 {
                    		 return '';
                    		 }else if(full.description.length>15){
                    			 return full.description.substring(0,15);
                    		 }else{
                ...
                { "bSortable": false, "aTargets": [0] },
				{
                    ...
                    "aTargets": [6],
                    "mRender": function (data, type, full) {
                        return '<div class="btn-group btn-group-xs" role="group"><a data-toggle="modal"     class="btn btn-success btn-xs" onclick="accept2(\''+full.aid+'\')"><i class="icon-edit icon-white"></i>通过</a>'+'&nbsp;'+'<a    class="btn btn-danger btn-xs"  onclick="noaccept2(\''+full.aid+'\')"><i class="icon-wrench icon-white" ></i>拒绝</a>' +'&nbsp;'+'<a    class="btn btn-primary btn-xs"  onclick="appli(\''+full.name+'\',\''+full.description+'\',\''+full.servicecode+'\',\''+full.aid+'\',\''+full.methodname+'\')"><i class="icon-wrench icon-white" ></i>详情</a></div>'  ;
                    }
                }],
                "aaSorting": [[4, 'desc']],
                "aLengthMenu": [
