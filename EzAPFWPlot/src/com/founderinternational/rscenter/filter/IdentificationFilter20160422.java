...
public class IdentificationFilter20160422 implements Filter {
   ...
   // private static Object keyob=new Object();
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1,
		    ...
		    if("flase"==flag)
		    {
		    	...
		    	//ProxyAuthFactory.getInstance().getSessionByuuid(Constants.AHTUURL+"HessianHelloWord", uuid);
		    	if((request.getSession().getAttribute("user")!=null&&casuuid==null)||flagurl)
			    	    ...
			    	    {   
						    ...
						    if(jsonstr!=null)
						    {
						    	...
						    	if(jsonob.get("result")!=null)
						    	{
						    		...
						    		{
						    			//{"result":"true","data":{"id":"440105197007150046","phone":"","roletyle":"0",
						    			//"username":"唐晓红",
						    			//"orgCode":"440100080600","idcard":"440105197007150046","PKILogin":true}}
