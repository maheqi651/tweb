...
scsso.baseurl = "http://sinacloud.com/";
scsso.ticket = null;
scsso.user = 0;
...
scsso.init = function(opt){
    ...
    scsso.loginurl = scsso.baseurl + scsso.loginurl;
    scsso.logouturl = scsso.baseurl + scsso.logouturl;
    scsso.pagelistener = scsso.baseurl + scsso.pagelistener;
    scsso.checkloginviajs = scsso.baseurl + scsso.checkloginviajs;
    scsso.loginboxjs = scsso.baseurl + scsso.loginboxjs;
    scsso.loginboxcss = scsso.baseurl + scsso.loginboxcss;
    ...
    var url = scsso.pagelistener + "&url=" + escape(scsso.crossdomainproxy);
...
scsso.logout = function(rtn_url){
    ...
    window.location=scsso.baseurl+"?m=sso&a=logout&callback="+rtn_url;
};
