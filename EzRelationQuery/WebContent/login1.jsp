...
<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%> 
<%@ page import="java.util.*,com.easymap.ticket.tools.*,com.easymap.management.newapi.*,com.easymap.management.api.*,com.easymap.management.user.User,com.easymap.management.entity.*" %>
<%
