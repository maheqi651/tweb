...
function searchTWFInfo(types){
	...
	var parm=new Object();
	requestUHB.hbaseInstance=HBase;
	requestUHB.hbaseTable="JZ_SHXX_JTWF";
	requestUHB.qasType=qtype;
	requestUHB.params=new Object();
	requestUHB.params.rowkey="";
	requestUHB.params.isBatch='false';
			...
			for(var o in restext.result)
            	{ 
            	           content="";
          				    ...
          				    //var tempcsmc=results2[o].CSMC.split("#");
            				 if(results2[o].JSZH==$("#idcard").val()){
            					 content+="<tr style='color:red'>"; 
            				 }else{
            					 content+="<tr >"; }
            				 //JSZH   DSR  HPHM HPZL-MC   WFDZ WFSJ    CLJGMC CLSJ  count
            				 content+="<td>"+results2[o].JSZH+"</td>";
            				 content+="<td>"+results2[o].DSR+"</td>";
