		...
		if(types=='01')
		{
			...
			var content="";
			 if(types=='01')
				...
				content="<table class='table table-bordered table-striped' border='1'> <thead> <tr>  <th width='10%'>姓名</th><th align='center' width='15%'>证件号</th>  <th width='20%'>旅馆名称</th>  <th width='8%'>房间号</th><th width='12%'>入住时间</th> <th width='12%'>退房时间</th> <th width='15%'>个人信息</th> </tr> </thead>";
