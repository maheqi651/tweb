		...
		function pagecontent(types) {
			...
			var content="";
			 if(types=='01')
				...
				content="<table class='table table-bordered table-striped' border='1'> <thead> <tr>  <th width='20%'>监所</th><th align='center' width='10%'>姓名</th> <th width='15%'>证件号</th>  <th align='center' width='10%'>姓别</th> <th width='15%'>入所时间</th><th width='15%'>出所时间</th><th width='15%'> 入所原因</th> </tr> </thead>";
				...
				content="<table class='table table-bordered table-striped' border='1'> <thead> <tr>  <th width='10%'>姓名</th><th align='center' width='10%'>证件号</th>     <th width='20%'>住所名称</th><th width='10%'>房间号</th><th width='15%'>入住时间</th><th width='15%'>退房时间</th><th width='10%'>住宿描述</th><th width='10%'> 个人信息</th> </tr> </thead>";
				
			}else if(types=='05'){
				
				
				content="<table class='table table-bordered table-striped' border='1'> <thead> <tr>  <th width='10%'>姓名</th><th align='center' width='15%'>证件号</th>  <th width='25%'>网吧名称</th>  <th width='15%'>上网时间</th> <th width='15%'>下网时间</th> <th width='10%'>同上网描述</th> <th width='10%'> 个人信息</th> </tr> </thead>";
			}else if(types=='06'){

				content="<table class='table table-bordered table-striped' border='1'> <thead> <tr>  <th width='10%'>车牌号</th><th align='center' width='8%'>姓名</th>   <th width='10%'>证件号</th><th width='15%'>违章地点</th>   <th width='10%'>违章时间</th><th width='15%'>处理机构</th><th width='13%'>处理时间</th><th width='10%'>违章次数</th>  <th width='10%'>违章详情</th>  </tr> </thead>";
			}
