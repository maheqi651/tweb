...
//			}
			...
			var content="";
			 if(types=='01')
				...
				content="<table class='table table-bordered table-striped' border='1'> <thead> <tr>  <th width='10%'>驾驶证号</th><th align='center' width='10%'>当事人</th>   <th width='15%'>车牌号</th> <th width='15%'>违章地点</th> <th width='15%'>违章时间</th><th width='15%'>处理机构</th><th width='15%'>处理时间</th> <th width='15%'> 同违章描述</th> </tr> </thead>";
			}
