...
$(document).ready(function() {
	 var obj=$('.slider3').slider({range:'min',orientation:'vertical',animate:true,  value:1});
	 
	 // alert($('.slider3').slider("option","values"));
	  var obj=$('.slider4').slider({range:'min',orientation:'vertical',animate:true,  value:1});
	 // $('.slider4').slider('pips', {first:'pip', last: 'pip'});
});
