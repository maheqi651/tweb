		...
		/*  String urlstr="iytga0SYE1adoDqnGDvWvWKkmSWTPGA79dFmMLJdph72vAP7Mc6UR2mbSHVakSKWDPlUrK4iIAZb%0D%0ALhQOk4LK642%2FWLn5XRbVDiNB6EYnmAGvj4NCTj%2Fra3P5yw%2BmSXREPmUoobLBW4alTriUbIuXyXRK%0D%0AOYsgQG6vvJmKcD3oA4c%3D";
		  ...
		  FileReader fr;
			try {
				...
				String publicKeyString=RSAUtil1.getKeystoreString("C:\\RSA\\publicKey.keystore");;
				PublicKey publickey=RSAUtil1.getPublicKey(publicKeyString);
			    String priatestring=RSAUtil1.getKeystoreString("C:\\RSA\\privateKey.keystore");
			    PrivateKey privateKey=RSAUtil1.getPrivateKey(priatestring);
			    String encodestr=RSAUtil1.encryptbypri(privateKey, "马赫器");
				System.out.println("encodestr:"+encodestr);
			    String plaint=RSAUtil1.decryptbyPub(publickey, encodestr);
