...
function loaddzda(idcard){
	...
	window.open("http://10.41.223.108:8080/EzERecord/?uuid="+idcard,'关系图展示','width='+(window.screen.availWidth-10)+',height='+(window.screen.availHeight-30)+',top=0,left=0,resizable=yes,status=yes,menubar=no,scrollbars=yes');
}
